...
class Book 
{
    ...
    constructor(title: string, author: string, isbn: string, year: number) 
    {
        this.title = title;
        this.author = author;
        this.isbn = isbn;
...
class Library 
{
    ...
    addBooksByDepartment(department: string, books: Book[]): void 
    {
    ...
    listBooksByDepartment(department: string): void 
    {
    ...
    searchBookByISBN(isbn: string): Book | undefined 
    {
...
function addBooksToLibrary() 
{
    ...
    {
        answer.departments.forEach((dept: string) => 
        {
...
const departments: { [key: string]: Book[] } = 
{
    microbiology: 
    [
